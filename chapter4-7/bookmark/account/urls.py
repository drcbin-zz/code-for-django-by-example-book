...
urlpatterns = [
        ...
        url(r'^password-reset/$', build_in_views.password_reset, name='password_reset'),
        url(r'^password-reset/done/$', build_in_views.password_reset_done, name='password_reset_done'),
